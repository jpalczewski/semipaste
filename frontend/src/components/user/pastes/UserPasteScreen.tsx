...
import {ButtonGroup, Collapse, Container, Form, Row} from "react-bootstrap";
import {Button, Flex, Spacer} from "@chakra-ui/react";
import {FontAwesomeIcon} from "@fortawesome/react-fontawesome";
import {solid} from "@fortawesome/fontawesome-svg-core/import.macro";
import {PaginationUtils} from "../../../utils/pagination";
import {PastesTable} from "../../dashboard/Pastes/table/PastesTable";
import {UserContext} from "../../../App";

export const UserPasteScreen = () => {
    ...
    const handleFilters = () => {
        ...
        url = handleURL(url, URLdateOfCreationLte, "dateOfCreation_Lte", dateOfCreationLte_value!);
