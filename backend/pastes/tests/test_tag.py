...
class TestSchema(GraphQLTestCase):
    ...
    def test_04_deleteTag_01(self) -> None:
        ...
        self.assertEqual(
            mutation_result["data"]["deleteTag"]["errorCode"], "POSSIBLE_FAILURE"
        )
    ...
    def test_05_deleteTag_02(self) -> None:
        ...
        self.assertEqual(
            mutation_result["data"]["deleteTag"]["response"], "No such tag"
        )
